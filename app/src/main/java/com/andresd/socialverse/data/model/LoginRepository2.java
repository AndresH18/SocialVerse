...
public class LoginRepository2 {
    ...
    private static final String TAG = LoginRepository2.class.getSimpleName();
    private static volatile LoginRepository2 instance;
    ...
    public static LoginRepository2 getInstance() {
        if (instance == null) {
            instance = new LoginRepository2();
        }
        return instance;
    }

    // private constructor : singleton
    private LoginRepository2() {
